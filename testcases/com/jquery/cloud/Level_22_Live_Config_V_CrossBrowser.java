...
public class Level_22_Live_Config_V_CrossBrowser extends BaseTest {
	...
	public void beforeClass(String browserName, String appUrl, String osName) {
		driver = getBrowserDriverCrossBrowser(browserName, appUrl, osName);
